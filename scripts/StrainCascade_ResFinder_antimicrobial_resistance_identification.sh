...
if [ "$#" -ne 10 ]; then
    echo "Usage: $0 <script_dir> <logs_dir> <apptainer_images_dir> <output_dir> <sample_name> <threads> <sequencing_type> <genome_assembly_main_abs> <functional_analysis_main_abs> <databases_dir>"
    exit 1
fi
